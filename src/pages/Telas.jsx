    ...
    return (
        <>
            <section className="d-flex align-items-center justify-content-center flex-column p-5">
                ...
                <div className="ctn-card card text-center ctn-multiproposito">
                    <div className="card-body d-flex align-items-center justify-content-center flex-column">
                ...
                <div className="ctn-card card text-center ctn-estampados">
                    <div className="card-body d-flex align-items-center justify-content-center flex-column">
                ...
                <div className="ctn-card card text-center d-flex flex-row p-0">
                ...
                {/* </div> */}
                <div className="ctn-card card text-center ctn-corderito">
                    <div className="card-body d-flex align-items-center justify-content-center flex-column">
                ...
                <div className="ctn-card card text-center ctn-tusores">
                    <div className="card-body d-flex align-items-center justify-content-center flex-column">
